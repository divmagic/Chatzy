...
class UsageControlModel {
  ...
  UsageControlModel.fromJson(Map<String, dynamic> json) {
    log("JSON : ${json['allowCreatingGroup']}");
    statusDeleteTime = json['statusDeleteTime'] ?? "24";
    allowCreatingBroadcast = json['allowCreatingBroadcast'] ?? true;
    allowCreatingGroup = json['allowCreatingGroup'] ?? true;
    ...
    existenceUsers = json['existenceUsers'] ?? true;
